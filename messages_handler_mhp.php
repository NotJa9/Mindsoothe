...
ini_set('display_errors', 0); // Important: Don't output errors in JSON response

// Include necessary files
include("connect.php");
// Make sure Pusher library exists
...
try {
    ...
    // Insert using the schema: (student_id, mhp_id, sender_type, receiver_type, message)
    $sql = "
